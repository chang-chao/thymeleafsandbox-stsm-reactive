...
public class StsmFluxWebConfig {
  ...
  // TODO * Once there is a Spring Boot starter for thymeleaf-spring5, there
  // would be no need to have
  // TODO that @EnableConfigurationProperties annotation or use it for declaring
  // the beans down in the
  // TODO "thymeleaf" section below.

  private ApplicationContext applicationContext;
  private ThymeleafProperties thymeleafProperties;

  public StsmFluxWebConfig(final ApplicationContext applicationContext,
  ...
  // TODO * If there was a Spring Boot starter for thymeleaf-spring5 most
  // probably some or all of these
  // TODO resolver and engine beans would not need to be specifically declared
  // here.
  ...
  public ThymeleafReactiveViewResolver thymeleafChunkedAndDataDrivenViewResolver() {
    ...
    // We are setting a size limit on the output buffers, which means thymeleaf
    // will be able to
